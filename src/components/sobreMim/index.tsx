            ...
            <section id="about" className={styles.section}>
                ...
                <div className={styles.container} >
                    ...
                    <p className={styles.description}>
                        ...
                        <br /><br />
                        Foi uma grande trajetória, onde aprendi muito sobre desenvolvimento. Mesmo após o fim da especialização, sigo estudando frequentemente sobre essa área que gosto tanto.
                        <br /><br />
